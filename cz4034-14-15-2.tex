...
\noindent To use top-down approach, we would split a group of students into two groups, then to four groups and so on until we satisfy. I would recommend him to use a bottom-up approach instead because that's the way human normal will do. 
