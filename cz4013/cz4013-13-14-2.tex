...
\noindent Assume that $p_2$ is a perfect clock and the drift rate between $p_3$ and $p_2$ is bounded by 10 ms per second. Then the time interval between $T_h$ and $T_a$ has errors:
