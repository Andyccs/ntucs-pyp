...
\todo[inline]{Update steps for calculation of doc2 for clearer explanation.}
\begin{center}
...
\todo[inline]{k-means can be used for supervised learning too. I will use both clustering algo, and evaluate using the measures such as precision, recall and f-measure. Should probably use the classifier with a high f1-measure. }
